 ...
 jQuery().ready(function() {
    ...
    $(".open6").click(function() {
      if (v.form()) {
        $("#loader").show();
         setTimeout(function(){
           $("#basicform").html('<h2 class="text-center">Thanks for your time.</h2>');
         }, 1000);
        return false;
      }
    });
...
// ========================================================================= //
 jQuery().ready(function() {
    var v = jQuery("#basicform01").validate({
      rules: {
        uname: {
          required: true,
          minlength: 2,
    ...
    $(".open60").click(function() {
      if (v.form()) {
        $("#loader").show();
         setTimeout(function(){
           $("#basicform01").html('<h2 class="text-center">Thanks for your time.</h2>');
         }, 1000);
        return false;
      }
    });
    ...
    $(".back40").click(function() {
      $(".frm1").hide("fast");
      $(".sf30").show("slow");
    });
    $(".back50").click(function() {
      $(".frm1").hide("fast");
      $(".sf40").show("slow");
    });
    $(".back60").click(function() {
      $(".frm1").hide("fast");
      $(".sf50").show("slow");
    });
  });
//  ===================================== //
  ...
  jQuery().ready(function() {
    var v = jQuery("#clinicform").validate({
      rules: {
        Ctype: {
          required: true,
        },
    ...
    $(".open06").click(function() {
      if (v.form()) {
        $("#loader").show();
         setTimeout(function(){
           $("#clinicform").html('<h2 class="text-center">Thanks for your time.</h2>');
         }, 1000);
        return false;
      }
    });
  ...
  jQuery().ready(function() {
    var v = jQuery("#addclinicform").validate({
      rules: {
        Ctype: {
          required: true,
        },
    ...
    $(".open005").click(function() {
      if (v.form()) {
        $("#loader").show();
         setTimeout(function(){
           $("#addclinicform").html('<h2 class="text-center">Thanks for your time.</h2>');
         }, 1000);
        return false;
      }
    });

    $(".back002").click(function() {
      $(".frm001").hide("fast");
      $("#sf001").show("slow");
    });

    $(".back003").click(function() {
      $(".frm001").hide("fast");
      $("#sf002").show("slow");
    });

    $(".back004").click(function() {
      $(".frm001").hide("fast");
      $("#sf003").show("slow");
    });

    $(".back005").click(function() {
      $(".frm001").hide("fast");
      $("#sf004").show("slow");
    });

    $(".back006").click(function() {
      $(".frm001").hide("fast");
      $("#sf005").show("slow");
    });
...
$("input:radio[value='Male']").parent().addClass('active');
